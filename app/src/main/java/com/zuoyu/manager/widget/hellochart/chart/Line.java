...
public class Line {
    ...
    public Line() {
        ...
        this.pointColor = 0;
        this.backgroundColor = Color.parseColor("#33ea5d55");
    ...
    public Line(Line line) {
        ...
        this.backgroundColor = line.backgroundColor;
        Iterator var2 = line.values.iterator();
