...
import com.zuoyu.manager.adapter.RechargeRecordAdapter;
...
public class RechargeRecordActivity extends BaseActivity {
    ...
    private List<RechargeRecordEntity.Recharge> list = new ArrayList<>();
    ...
    public void initView() {
        ...
        adapter = new RechargeRecordAdapter(context, list);
    ...
    public void parseRechargeRecord(Map<String, String> params) {
        ...
        httpUtil.post(params, UrlManage.RECHARGE_RECORD_URL, new HttpResult<RechargeRecordEntity>() {
            @Override
            ...
            public void onSuccess(RechargeRecordEntity result) {
                ...
                pullUtil.setEmptyView(list, R.mipmap.icon_no_coupons, getString(R.string.sorry_no_recharge_record));
